...
class ModelValidatorTest extends TestCase
{
    ...
    public function testInvalidIdentifyModelFailsValidation(): void
    {
        ...
        try {
            ...
            $this->assertInstanceOf(WebhookException::class, $exception, 'Expected WebhookException was thrown');
            $this->assertEquals(
    ...
    public function testValidIdentifyModelFailsValidation(): void
    {
        $model = new IdentifyModel();
        ...
        try {
            $this->unit->validate($model);
            $this->assertTrue(true, 'No WebhookException was thrown'); // force test to pass
