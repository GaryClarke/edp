...
class NewsletterWebhookFactory
{
    ...
    public function createFromWebhook(Webhook $webhook): NewsletterWebhook
    {
        try {
            ...
            throw new WebhookException('Unable to create NewsletterWebhook because ' . $throwable->getMessage());
        }
    }
}
